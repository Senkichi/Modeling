...
**The percentage of mature forest had a significant positive correlation (p-value = 0.0388) with the liklihood that a site was a nest site. Each percent of mature forest corresponded to a 3.46% (95% CI .33%-7.12%) increase in the odds of a site being a nest site.** ##check my wording here, I'm also not sure how the figure should be referenced
...
```
**The probability that a site with 30% mature forest is a nesting site rather than a random site is 0.37.**
...
**It would be ill-advised to include all of the body size measurements because the more variables you include creates additional degrees of freedom. The strongly correlated variables decrease in impact with the addition of more variables.**
